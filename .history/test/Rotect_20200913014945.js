...
contract("RotectDAO ", () => {
  ...
  it("Should update Minimum Project Funds", async () => {
    ...
    assert.strictEqual(receipt !== null, true);
    console.log("UpdateProjectMinFunds: ", receipt.events.UpdateProjectMinFunds.returnValues);
  });
  it("Should update Max Project Funds", async () => {
    ...
    assert.strictEqual(receipt !== null, true);
    console.log("UpdateProjectMaxFunds: ", receipt.events.UpdateProjectMaxFunds.returnValues);
  });
