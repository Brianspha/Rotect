...
contract("RotectDAO ", () => {
  ...
  it('Should get all projects submission keys', async()=>{
      var keys = await RotectDAO.methods.getAllProjectSubmissionKeys().call()
    console.log('project submission keys: ')
  })
  it("Should get a project submission", async()=>{
      var project  = await RotectDAO.methods.getProjectSubmission()
  })
});
